...
<beans xmlns="http://www.springframework.org/schema/beans"
	...
	<bean id="dataSource" class="com.mchange.v2.c3p0.ComboPooledDataSource"
		destroy-method="close" p:driverClass="${dbConfig.driver}"
		p:jdbcUrl="${dbConfig.url}" p:user="${dbConfig.username}"
		p:password="${dbConfig.password}" p:maxPoolSize="40" p:minPoolSize="1"
	...
	<bean id="sessionFactory"
		...
		<property name="hibernateProperties">
			...
			<value>
				hibernate.dialect=${dbConfig.dialect}
